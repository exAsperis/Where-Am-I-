...
export const PENDING_PARTY_ACTIONS_METADATA_KEY = `${EXTENSION_NAMESPACE}/pending-party-actions`;
export const PENDING_PARTY_GROUP_ITEM_METADATA_KEY = `${EXTENSION_NAMESPACE}/pending-party-group`;
export const PENDING_PARTY_ACTION_ITEM_METADATA_KEY = `${EXTENSION_NAMESPACE}/pending-party-action`;
export const PENDING_FOCUS_PARTY_ITEM_METADATA_KEY = `${EXTENSION_NAMESPACE}/pending-focus-party`;
...
export const MAX_HIGHLIGHT_THICKNESS = 100;
